...
return [
    ...
    */
    ...
    | атрибутов с использованием соглашения "attribute.rule", чтобы
    | быстро указать конкретную строку для данного правила атрибута.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Следующие строки используются для замены нашего заполнитель атрибута
    | чем-то более читабельным, например, "Адрес электронной почты" вместо
    | "email". Это просто помогает нам сделать сообщение более выразительным.
    |
    */
